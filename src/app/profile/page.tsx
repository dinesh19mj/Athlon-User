  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground font-sans pb-24 overflow-y-auto selection:bg-[#1B9C56] selection:text-black">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between px-4 py-4 bg-background/90 backdrop-blur-md border-b border-foreground/5">
        ...
        <button className="p-2 -mr-2 text-foreground hover:text-gray-300 transition-colors">
      ...
      <main className="w-full max-w-lg mx-auto px-4 flex flex-col gap-6 pt-6">
        ...
        <section className="flex flex-col items-center relative">
          ...
          <div className="relative mb-4">
            ...
            <div className="relative w-24 h-24 rounded-full bg-[#1B9C56] p-[3px]">
              <div className="w-full h-full rounded-full bg-background border-4 border-[#0A0F1A] overflow-hidden">
            ...
            {/* Level Badge */}
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-surface border border-[#1B9C56] px-3 py-0.5 rounded-full shadow-[0_0_10px_rgba(0,255,102,0.3)]">
              <span className="text-[10px] font-black text-[#1B9C56] uppercase tracking-widest whitespace-nowrap">Pro Lvl 5</span>
            </div>
          </div>

          <h2 className="text-2xl font-black text-foreground tracking-wide mt-2">Dinesh Kumar</h2>
          ...
          {/* XP Progress Bar */}
          <div className="w-full max-w-[240px] mt-6 bg-surface border border-foreground/5 p-3 rounded-2xl flex flex-col gap-2">
            <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-foreground/60">
              <span>XP 2,450</span>
        ...
        <section className="grid grid-cols-2 gap-3 mt-2">
          <button className="flex items-center justify-center gap-2 bg-surface border border-foreground/10 hover:border-foreground/30 text-foreground text-xs font-bold py-3.5 rounded-xl transition-all shadow-lg">
            <Edit3 className="w-4 h-4 text-foreground/70" /> Edit Profile
          </button>
          <button className="flex items-center justify-center gap-2 bg-[#1B9C56]/20 border border-blue-500/30 hover:border-blue-500/60 text-foreground text-xs font-bold py-3.5 rounded-xl transition-all shadow-lg">
