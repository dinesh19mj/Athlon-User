    ...
    <div className="h-[calc(100vh-156px)] md:h-[calc(100vh-64px)] overflow-hidden bg-background text-foreground flex flex-col">
      <div className="p-6 border-b border-foreground/10 flex flex-col gap-4 shrink-0">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground/50 text-xs font-bold mt-1">Total: 155 Enrolled</p>
          </div>
        ...
        <div className="flex gap-2">
          <div className="flex-1 bg-surface border border-foreground/10 rounded-xl px-3 py-2.5 flex items-center gap-2">
            ...
            <input type="text" placeholder="Search students..." className="bg-transparent border-none outline-none text-sm text-foreground w-full placeholder:text-foreground/40" />
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-3 hide-scrollbar">
        {students.map((student) => (
          <div key={student.id} className="bg-surface/80 backdrop-blur-md border border-foreground/5 rounded-2xl p-4 shadow-xl flex items-center justify-between">
