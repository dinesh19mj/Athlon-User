    ...
    <div className="h-[calc(100vh-156px)] md:h-[calc(100vh-64px)] overflow-hidden bg-[#0A0F1A] text-white flex flex-col relative">
      ...
      <div className="relative z-10 flex-1 overflow-y-auto hide-scrollbar">
        ...
        <div className="px-6 pt-8 pb-6 border-b border-white/10 relative overflow-hidden">
          ...
          <p className="text-white/80 text-sm font-medium mb-6 relative z-10">Here's your academy overview for today.</p>
          ...
          <div className="flex gap-3 relative z-10">
            <div className="flex-1 bg-black/40 border border-white/10 backdrop-blur-md rounded-2xl p-4 flex flex-col justify-center shadow-lg">
              <span className="text-[10px] font-black text-white/60 uppercase tracking-widest mb-1">Students</span>
              <div className="flex items-end gap-2">
                <span className="text-2xl font-black text-white">155</span>
        ...
        <div className="p-6 overflow-hidden">
          <h2 className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-4 pl-1">Academy Operations</h2>
          <section className="flex items-center gap-3 overflow-x-auto pb-4 pt-1 snap-x scroll-px-6 hide-scrollbar -mx-6 px-6 md:mx-0 md:px-0">
            ...
            <Link href="/academy/batches" className="flex flex-col items-center gap-1.5 shrink-0 snap-start">
              <div className="w-[68px] h-[68px] rounded-[16px] bg-[#121824] border border-[#F97316]/30 hover:border-[#F97316] flex flex-col items-center justify-center transition-colors shadow-lg cursor-pointer">
                <BookOpen className="w-6 h-6 text-[#F97316]" strokeWidth={1.5} />
              </div>
              <span className="text-[10px] font-medium text-white/80">New Batch</span>
            </Link>
          </section>
        </div>
