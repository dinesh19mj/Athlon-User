      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center lg:text-left mb-8">
             <h2 className="text-4xl font-black text-foreground tracking-wide">Login</h2>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button 
              type="submit"
              className="w-full bg-[#1B9C56] text-foreground font-bold py-4 px-4 rounded-xl hover:opacity-90 active:scale-95 transition-all mt-6 shadow-[0_0_20px_rgba(27,156,86,0.3)]"
            >
              Sign In
            </button>
