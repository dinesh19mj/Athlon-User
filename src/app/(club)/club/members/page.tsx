  ...
  return (
    <div className="h-[calc(100vh-156px)] md:h-[calc(100vh-64px)] overflow-hidden bg-[#0A0F1A] text-white flex flex-col">
      <div className="p-6 border-b border-white/10 flex flex-col gap-4 shrink-0">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-white/50 text-xs font-bold mt-1">Total: 42 Active Members</p>
          </div>
        ...
        <div className="flex gap-2">
          <div className="flex-1 bg-[#121824] border border-white/10 rounded-xl px-3 py-2.5 flex items-center gap-2">
            ...
            <input type="text" placeholder="Search members..." className="bg-transparent border-none outline-none text-sm text-white w-full placeholder:text-white/40" />
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-3 hide-scrollbar">
        {members.map((member) => (
          <div key={member.id} className="bg-[#121824]/80 backdrop-blur-md border border-white/5 rounded-2xl p-4 shadow-xl flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/50 uppercase tracking-wider">Joined: {member.joined}</p>
              </div>
            </div>
